...
import com.xin.pay.exception.aop.annotation.PayChannelException;
import com.xin.pay.exception.aop.constant.MethodPrefix;
import com.xin.pay.exception.aop.constant.RedisPrefix;
import com.xin.pay.exception.aop.enums.ReturnDataFormatEnum;
import com.xin.pay.exception.aop.exception.UxinPaySysException;
import com.xin.pay.exception.aop.redis.ChannelExceptionRedis;
...
public class PayChannelExceptionHandler extends AbstractHandler {
    ...
    @Override
    @Pointcut("@annotation(com.xin.pay.exception.aop.annotation.PayChannelException)")
